...
calm_small = calm.loc[0:20,["username", "is_verified", "media_count","follower_count","following_count","total_igtv_videos","total_clips_count","usertags_count","has_highlight_reels","is_business","account_type","engagement_rate","is_person_category","influencer_score","calm_influencer_score"]]
#print(calm_small.head())
